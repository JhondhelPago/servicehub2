                ...
                <div className="flex flex-col gap-5 p-5 my-5 rounded-lg bg-gray-50 hover:shadow-lg hover:bg-white min-w-[90%] max-w-[90%]">
                    <div className="flex flex-col justify-between gap-5 lg:flex-row">
                        ...
                        <div className="grid gap-5 text-white grid-flow-dense md:grid-flow-col">
                            <button className="flex items-center justify-between w-4/5 gap-2 p-3 mx-auto bg-green-600 rounded-lg md:mx-0 md:w-auto scaleHover">
                                Approve
                            ...
                            <button className="flex items-center justify-between w-4/5 gap-2 p-3 mx-auto rounded-lg md:mx-0 md:w-auto scaleHover bg-darkColor">
                                View Stats
                                ...
                                <svg className="hidden h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g fill="none" fillRule="evenodd"><path d="M24 0v24H0V0zM12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035c-.01-.004-.019-.001-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427c-.002-.01-.009-.017-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093c.012.004.023 0 .029-.008l.004-.014l-.034-.614c-.003-.012-.01-.02-.02-.022m-.715.002a.023.023 0 0 0-.027.006l-.006.014l-.034.614c0 .012.007.02.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z" /><path fill="currentColor" d="M11.293 8.293a1 1 0 0 1 1.414 0l5.657 5.657a1 1 0 0 1-1.414 1.414L12 10.414l-4.95 4.95a1 1 0 0 1-1.414-1.414z" /></g></svg>
                            </button>
                            <button className="flex items-center justify-between w-4/5 gap-2 p-3 mx-auto bg-red-600 rounded-lg md:mx-0 md:w-auto scaleHover" onClick={() => { removeFnc(props.data) }}>
                                Remove
                            ...
                            <button className="flex items-center justify-between w-4/5 gap-2 p-3 mx-auto rounded-lg md:mx-0 md:w-auto scaleHover bg-primary-light" onClick={() => { ParentFunc(props.data) }}>
                                Edit
                    ...
                    {/* <!-- post info --> */}
                    <div className="flex flex-col items-center gap-5 p-3 rounded-lg sm:flex-row bg-gradient-to-r from-gradient-primary-light-from to-transparent">
                        ...
                        {/* <!-- img --> */}
                        <img className="object-cover w-32 h-32 rounded-lg hover:cursor-pointer" onclick="enlargeImg()" id="smallImg" src={require(`../../../../server/FileUpload/${ImageStringUtils.FirstImageElement(props.data.imagefiles)}`)} alt={ImageStringUtils.FirstImageElement(props.data.imagefiles)} />
