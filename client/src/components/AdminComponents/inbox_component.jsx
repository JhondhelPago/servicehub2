...
const MailOverView = ({ MailObjsArray, ContactClientId, handleViewProfile, CloseMailOverViewAction, setIsMailViewOpen, isMailViewOpen, FetchConvo_Admin_Client }) => {
...
const MailInnerView = ({ MailObj }) => {
    ...
    const [ImageArray, setImagArray] = useState(null);
    const [DocuArray, setDocuArray] = useState(null);

    const [ImageArrayType, setImageArrayType] = useState('');
    const [DocuArrayType, setDocuArrayType] = useState('');
