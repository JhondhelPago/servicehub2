    ...
    return (
        <>
            ...
            <div className="flex font-poppins">
                {/* <!-- nav --> */}
                <nav className="sticky top-0 flex flex-col h-screen px-3 text-white py-7 gap-7 bg-gradient-to-b from-gradient-dark-from to-gradient-dark-to group/label">
                    ...
                    <div className="flex flex-col h-full gap-1 overflow-auto" id="linksContainer">
                        <button className="group-hover/label:justify-between navHover group/tooltip" id="links" onClick={() => { SelectComponent('dashboard') }}>
