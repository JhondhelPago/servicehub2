...
async function clientuserLoginSession(email, password){//return the id of this clientuser login session


    try{

        const [rowdata] = await pool.execute(`SELECT id FROM user WHERE email = ? AND password = ?`, [email, password]);
